...
# or Skype or even Office. As this issue is location dependent for some domains,
# they are not commented by default. The domains known to cause issues marked
# accordingly. Please see the related issue:
